...
// node_modules/@tma.js/sdk/dist/index.mjs
var It = Object.defineProperty;
var Tt = (r, t, e) => t in r ? It(r, t, { enumerable: true, configurable: true, writable: true, value: e }) : r[t] = e;
...
var ut = "https://web.telegram.org";
var k = new ht("[SDK]", false);
function Qe(r) {
  if (r) {
    k.enable();
    return;
...
var K = class _K extends Error {
  constructor(t, e) {
    super(`Method "${t}" is unsupported in the Mini Apps version ${e}.`), Object.setPrototypeOf(this, _K.prototype);
  }
};
var Y = class _Y extends Error {
  constructor(t, e, s) {
    super(`Parameter "${e}" in method "${t}" is unsupported in the Mini Apps version ${s}.`), Object.setPrototypeOf(this, _Y.prototype);
  }
};
function Ot(r) {
  return (t, e) => {
...
var j = class _j extends Error {
  constructor(e, { cause: s, type: n } = {}) {
    ...
    o(this, "type");
    this.value = e, Object.setPrototypeOf(this, _j.prototype), this.type = n;
  }
};
var G = class _G extends Error {
  constructor(t, { cause: e, type: s } = {}) {
    super(`Unable to parse field "${t}"${s ? ` as ${s}` : ""}`, { cause: e }), Object.setPrototypeOf(this, _G.prototype);
  }
};
function dt(r, t) {
  const e = {};
...
var w = class {
   ...
   */
  on(t, e) {
    return this.addListener(t, e, false);
  }
  /**
   ...
   */
  once(t, e) {
    return this.addListener(t, e, true);
  }
  /**
...
var J = "telegram-mini-apps-cached-emitter";
function H() {
  const r = window;
...
var z = class _z extends Error {
  constructor(t) {
    super(`Async call timeout exceeded. Timeout: ${t}`), Object.setPrototypeOf(this, _z.prototype);
  }
};
function te(r) {
...
var m = class {
  ...
  internalSet(t, e) {
    return this.state[t] === e || e === void 0 ? false : (this.state[t] = e, this.ee.emit(`change:${t}`, e), true);
  }
  /**
...
var re = class {
  constructor(t, e, s = d) {
    o(this, "ee", new w());
    o(this, "state");
    o(this, "on", (t2, e2) => t2 === "click" ? E("back_button_pressed", e2) : this.ee.on(t2, e2));
    o(this, "off", (t2, e2) => t2 === "click" ? I("back_button_pressed", e2) : this.ee.off(t2, e2));
    o(this, "supports");
...
var mt = R((r) => r instanceof Date ? r : new Date(x().parse(r) * 1e3), "Date");
function et(r, t) {
  return new F((e) => {
...
var le = class {
  constructor(t, e = d) {
    ...
    o(this, "off", this.ee.off.bind(this.ee));
    o(this, "supports");
    this.postEvent = e, this.state = new m({ isOpened: false }, this.ee), this.supports = C(t, { open: "web_app_open_invoice" });
  }
  set isOpened(t) {
...
var de = class {
  constructor(t) {
    ...
    o(this, "on", (t2, e2) => (
      ...
      t2 === "click" ? E("main_button_pressed", e2) : this.ee.on(t2, e2)
    ));
    o(this, "off", (t2, e2) => t2 === "click" ? I("main_button_pressed", e2) : this.ee.off(t2, e2));
    const {
      postEvent: e = d,
      text: s,
      textColor: n,
...
var we = class {
  constructor(t) {
    ...
    o(this, "requestingPhoneAccess", false);
    o(this, "requestingWriteAccess", false);
    o(this, "on", this.ee.on.bind(this.ee));
    o(this, "off", this.ee.off.bind(this.ee));
    o(this, "supports");
  ...
  requestPhoneAccess(t = {}) {
    ...
    return this.requestingPhoneAccess = true, y("web_app_request_phone", "phone_requested", {
      ...t,
      postEvent: this.postEvent
  ...
  requestWriteAccess(t = {}) {
    ...
    return this.requestingWriteAccess = true, y("web_app_request_write_access", "write_access_requested", {
      ...t,
      postEvent: this.postEvent
    }).then((e) => e.status).finally(() => {
...
var be = class {
  constructor(t, e = d) {
    ...
    o(this, "off", this.ee.off.bind(this.ee));
    o(this, "supports");
    this.postEvent = e, this.state = new m({ isOpened: false }, this.ee), this.supports = C(t, { open: "web_app_open_popup" });
  }
  set isOpened(t) {
    this.state.set("isOpened", t);
  }
  ...
  open(t) {
    ...
    return this.isOpened = true, y("web_app_open_popup", "popup_closed", {
      postEvent: this.postEvent,
      params: _e(t)
...
var me = class {
  constructor(t, e = d) {
    ...
    o(this, "off", this.ee.off.bind(this.ee));
    o(this, "supports");
    this.postEvent = e, this.state = new m({ isOpened: false }, this.ee), this.supports = C(t, {
...
var ye = class {
  constructor(t, e, s = d) {
    o(this, "ee", new w());
    o(this, "state");
    o(this, "on", (t2, e2) => t2 === "click" ? E("settings_button_pressed", e2) : this.ee.on(t2, e2));
    o(this, "off", (t2, e2) => t2 === "click" ? I("settings_button_pressed", e2) : this.ee.off(t2, e2));
    o(this, "supports");
    this.postEvent = s, this.state = new m({ isVisible: t }, this.ee), this.supports = C(e, {
...
var xe = class {
   ...
   */
  expand() {
    this.postEvent("web_app_expand"), this.state.set("isExpanded", true);
  }
  /**
...
function Re(r, t, e) {
  const { isVisible: s = false } = r ? $("back-button") || {} : {}, n = new re(s, t, e);
  return n.on("change", () => {
    T("back-button", { isVisible: n.isVisible });
  }), n;
}
function Ie(r, t) {
  const { isConfirmationNeeded: e = false } = r ? $("closing-behavior") || {} : {}, s = new se(e, t);
...
function Be(r, t, e) {
  const { isVisible: s = false } = r ? $("settings-button") || {} : {}, n = new ye(s, t, e);
  return n.on("change", () => {
...
var At = "telegram-mini-apps-launch-params";
function Ge() {
...
function rr(r = {}) {
  ...
  try {
    ...
    pt() && (n && Ve(), l("iframe_ready", { reload_supported: true }), E("reload_iframe", () => {
...
async function O(r) {
  return r === 0 ? true : Promise.race([
    new Promise((t) => {
      window.addEventListener("popstate", function e() {
        window.removeEventListener("popstate", e), t(true);
      }), window.history.go(r);
    }),
...
var Rt = class _Rt extends ze {
  constructor(e, s, n = {}) {
    ...
    o(this, "ee", new w());
    o(this, "attached", false);
    o(this, "onPopState", async ({ state: e2 }) => {
      if (this.logger.log('"popstate" event received. State:', e2), e2 === null)
  ...
  static fromLocation(e) {
    ...
    return new _Rt([{ search: s, pathname: n, hash: i }], 0, e);
  }
  async performGo(e) {
  ...
  async attach() {
    if (!this.attached)
      return this.logger.log("Attaching", this), this.attached = true, E("back_button_pressed", this.back), this.syncHistory();
  }
  /**
   * Detaches current navigator from the browser history.
   */
  detach() {
    this.attached && (this.logger.log("Detaching", this), this.attached = false, window.removeEventListener("popstate", this.onPopState), I("back_button_pressed", this.back));
  }
};
function or(r) {
